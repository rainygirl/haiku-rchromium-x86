...
bool ShellBrowserMainParts::MainMessageLoopRun(int* result_code)  {
  fprintf(stderr, "[RCH] MainMessageLoopRun: run_message_loop_=%d "
                  "(returning %d; true means the default loop is skipped)\n",
          (int)run_message_loop_, (int)!run_message_loop_);
  return !run_message_loop_;
}

void ShellBrowserMainParts::PostMainMessageLoopRun() {
  fprintf(stderr, "[RCH] PostMainMessageLoopRun: the loop has returned\n");
